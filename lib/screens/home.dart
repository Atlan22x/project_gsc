              ...
              itemBuilder: (context) => <PopupMenuEntry<Menu>>[
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        title: Text('Profilku', style: TextStyle(fontSize: 16),),
                ...
                const PopupMenuItem<Menu>(
                  ...
                  child: ListTile(
                    ...
                    textColor: greyColor,
                    dense: true,
                    leading: Icon(Icons.lock_outline, size: 28,),
                    title: Text('Privasi', style: TextStyle(fontSize: 16),),
                    trailing: Icon(Icons.keyboard_arrow_right),
                  ),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        title: Text('Bahasa', style: TextStyle(fontSize: 16),),
                        trailing: Icon(Icons.keyboard_arrow_right),
                      ),
                    ],
                  ),
                ...
                const PopupMenuItem<Menu>(
                  ...
                  child: ListTile(
                    ...
                    textColor: greyColor,
                    dense: true,
                    leading: Icon(Icons.dark_mode_outlined, size: 28,),
                    title: Text('Tampilan', style: TextStyle(fontSize: 16),),
                    trailing: Icon(Icons.keyboard_arrow_right),
                  ),
                ),
                const PopupMenuDivider(height: 20),
